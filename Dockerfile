...
#RUN wget https://data.gtdb.ecogenomic.org/releases/latest/auxillary_files/gtdbtk_data.tar.gz && tar xvf gtdbtk_data.tar.gz && rm gtdbtk_data.tar.gz
# The following is the mirror download, which is sometimes faster
RUN wget https://data.ace.uq.edu.au/public/gtdb/data/releases/latest/auxillary_files/gtdbtk_data.tar.gz && tar xvf gtdbtk_data.tar.gz && rm gtdbtk_data.tar.gz
...
RUN cat welcome_message >> /home/jovyan/.bashrc
